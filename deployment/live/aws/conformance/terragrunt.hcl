locals {
  ...
  ecr_repository_conformance = get_env("ECR_REPOSITORY_CONFORMANCE", "static-ct-ci/conformance:latest")
  ecr_repository_hammer      = get_env("ECR_REPOSITORY_HAMMER", "static-ct-ci/hammer:latest")
  ephemeral                  = true
}
